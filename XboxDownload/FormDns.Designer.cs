namespace XboxDownload
{
    partial class FormDns
    {
        ...
        private void InitializeComponent()
        {
            ...
            cbHostName.Items.AddRange(new object[] { "assets1.xboxlive.cn", "assets2.xboxlive.cn", "dl.delivery.mp.microsoft.com", "gst.prod.dl.playstation.net", "atum.hac.lp1.d4c.nintendo.net", "origin-a.akamaihd.net", "blzddist1-a.akamaihd.net", "epicgames-download1.akamaized.net", "www.baidu.com" });
