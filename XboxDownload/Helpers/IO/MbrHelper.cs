...
{
    public static ReadOnlySpan<byte> DiskSignatureBytes => [0x12, 0x34, 0x56, 0x78];
    public static ReadOnlySpan<byte> PcMode => [0x55, 0xAA];
    public static ReadOnlySpan<byte> XboxMode => [0x99, 0xCC];
